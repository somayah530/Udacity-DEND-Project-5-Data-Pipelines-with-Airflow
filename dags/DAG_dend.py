...
default_args = {  # The DAG doesn't have dependencies on past runs
...
dag = DAG('DAG_dend', default_args=default_args,
...
load_songplays_table = \
    LoadFactOperator(task_id='Load_songplays_fact_table', dag=dag,
                     redshift_conn_id='redshift', table='songplays',
                     sql_query=SqlQueries.songplay_table_insert)

load_user_dimension_table = \
    LoadDimensionOperator(task_id='Load_user_dim_table', dag=dag,
                          redshift_conn_id='redshift', table='users',
                          sql_query=SqlQueries.user_table_insert)

load_song_dimension_table = \
    LoadDimensionOperator(task_id='Load_song_dim_table', dag=dag,
...
load_time_dimension_table = \
    LoadDimensionOperator(task_id='Load_time_dim_table', dag=dag,
                          redshift_conn_id='redshift', table='time',
                          sql_query=SqlQueries.time_table_insert)

run_quality_checks = \
    DataQualityOperator(task_id='Run_data_quality_checks', dag=dag,
                        redshift_conn_id='redshift', table=['songplay',
                        'users', 'song', 'artist', 'time'])
